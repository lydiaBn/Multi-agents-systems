    ...
    private class OfferRequestsServer extends CyclicBehaviour {
        public void action() {
            ...
            if (msg != null) {
                ...
                // Ici vous pouvez définir la proposition d'achat en fonction de l'offre du vendeur
                // Par exemple, vous pouvez inclure les détails sur le produit et son prix.
