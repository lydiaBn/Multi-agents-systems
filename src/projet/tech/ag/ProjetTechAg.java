...
public class ProjetTechAg {
   ...
   public static void main(String[] args) {
    ...
    try {
        ...
        p1.setParameter(Profile.CONTAINER_NAME, "SellerContainer1"); // Nom du conteneur pour Seller1
        ...
        p2.setParameter(Profile.CONTAINER_NAME, "SellerContainer2"); // Nom du conteneur pour Seller2
